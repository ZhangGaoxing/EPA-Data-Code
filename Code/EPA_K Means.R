...
save(EPA_K_Means_Jazz_Ht_10_2S_DR, file="./Result Objects/EPA_K_Means_Jazz_Ht_10_2S_DR.RData")

EPA_K_Means_Jazz_Ht_10_2S_AED[[i]]=outer_sum
save(EPA_K_Means_Jazz_Ht_10_2S_AED, file="./Result Objects/EPA_K_Means_Jazz_Ht_10_2S_AED.RData")
	i=i+1
