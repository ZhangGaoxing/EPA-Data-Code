...
save(Random_Hetero_30, file="./200_t/Random_Hetero_30.4.RData")
save(Random_Hetero_30_Time, file="./200_t/Random_Hetero_30_Time.4.RData")

# load("./200_t/Random_Hetero_60.3.RData")
# load("./200_t/Random_Hetero_60_Time.3.RData")
# f3 <- Random_Hetero_60
# t3 <- Random_Hetero_60_Time

# Random_Hetero_60 <- c(f1,f2,f3)
# Random_Hetero_60_Time <- c(t1,t2,t3)
